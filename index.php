...
<body class="text-left">
    <nav style="width:100%;align-self:start" class="navbar navbar-expand navbar-light bg-light">
    ...
    <form class="form" id="imageencode" action="encode.php" method="POST" target="_blank" enctype="multipart/form-data">
        <fieldset class="form-group row">
            ...
            <div class="col-sm-1-12">
                <div class="form-group">
                    ...
                    <input type="text" name="secret" id="secret" class="form-control" placeholder="THIS IS A SECRET"
                ...
                <div class="form-group">
                    ...
                    <small id="photohelp" class="text-muted">Image you want to hide a message in</small>
                    <img id='img-upload' />
                </div>
